...
class nkujcSpider(CrawlSpider): 
    name = "nkujcSpider"         
    allowed_domains = ["jc.nankai.edu.cn"]
    start_urls = ["http://jc.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkujcSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        snapshot_name = f"jc_{self.page_id}.png"
