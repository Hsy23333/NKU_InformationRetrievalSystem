...
class nkustatSpider(CrawlSpider): 
    name = "nkustatSpider"         
    allowed_domains = ["stat.nankai.edu.cn"]
    start_urls = ["http://stat.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkustatSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'stat' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"stat_{self.page_id}.png"
