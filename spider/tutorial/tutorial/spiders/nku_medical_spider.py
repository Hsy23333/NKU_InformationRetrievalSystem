...
class nkumedicalSpider(CrawlSpider): 
    name = "nkumedicalSpider"         
    allowed_domains = ["medical.nankai.edu.cn"]
    start_urls = ["http://medical.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkumedicalSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'medical' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"medical_{self.page_id}.png"
