...
class nkulawSpider(CrawlSpider): 
    name = "nkulawSpider"         
    allowed_domains = ["law.nankai.edu.cn"]
    start_urls = ["http://law.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkulawSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'law' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"law_{self.page_id}.png"
