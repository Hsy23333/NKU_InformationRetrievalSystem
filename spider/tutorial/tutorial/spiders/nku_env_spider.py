...
class nkuenvSpider(CrawlSpider): 
    name = "nkuenvSpider"         
    allowed_domains = ["env.nankai.edu.cn"]
    start_urls = ["http://env.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkuenvSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        snapshot_name = f"env_{self.page_id}.png"
