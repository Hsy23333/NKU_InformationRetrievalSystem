...
class nkutasSpider(CrawlSpider): 
    name = "nkutasSpider"         
    allowed_domains = ["tas.nankai.edu.cn"]
    start_urls = ["http://tas.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkutasSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'tas' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"tas_{self.page_id}.png"
