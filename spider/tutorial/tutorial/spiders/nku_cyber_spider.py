...
class nkucyberSpider(CrawlSpider): 
    name = "nkucyberspider"         
    allowed_domains = ["cyber.nankai.edu.cn"]
    start_urls = ["http://cyber.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkucyberSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'cyber'
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"cyber_{self.page_id}.png"
