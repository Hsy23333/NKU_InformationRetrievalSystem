...
class nkujwcoldSpider(CrawlSpider): 
    name = "nkujwcoldSpider"         
    allowed_domains = ["jwcold.nankai.edu.cn"]
    start_urls = ["http://jwcold.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkujwcoldSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'jwcold' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"jwcold_{self.page_id}.png"
