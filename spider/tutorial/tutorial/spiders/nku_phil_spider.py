...
class nkuphilSpider(CrawlSpider): 
    name = "nkuphilSpider"         
    allowed_domains = ["phil.nankai.edu.cn"]
    start_urls = ["http://phil.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkuphilSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'phil' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"phil_{self.page_id}.png"
