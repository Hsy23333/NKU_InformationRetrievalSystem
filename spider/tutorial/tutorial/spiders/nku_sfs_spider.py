...
class nkusfsSpider(CrawlSpider): 
    name = "nkusfsSpider"         
    allowed_domains = ["sfs.nankai.edu.cn"]
    start_urls = ["http://sfs.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkusfsSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'sfs' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"sfs_{self.page_id}.png"
