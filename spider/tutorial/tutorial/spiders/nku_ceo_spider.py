...
class nkuceoSpider(CrawlSpider): 
    name = "nkuceoSpider"         
    allowed_domains = ["ceo.nankai.edu.cn"]
    start_urls = ["http://ceo.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkuceoSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'ceo' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"ceo_{self.page_id}.png"
