...
class nkushxySpider(CrawlSpider): 
    name = "nkushxySpider"         
    allowed_domains = ["shxy.nankai.edu.cn"]
    start_urls = ["http://shxy.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkushxySpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'shxy' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"shxy_{self.page_id}.png"
