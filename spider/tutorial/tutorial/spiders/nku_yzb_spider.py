...
class nkuyzbSpider(CrawlSpider): 
    name = "nkuyzbSpider"         
    allowed_domains = ["yzb.nankai.edu.cn"]
    start_urls = ["http://yzb.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkuyzbSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'yzb' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"yzb_{self.page_id}.png"
