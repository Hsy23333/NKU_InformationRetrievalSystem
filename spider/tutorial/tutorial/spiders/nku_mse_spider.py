...
class nkumseSpider(CrawlSpider): 
    name = "nkumseSpider"         
    allowed_domains = ["mse.nankai.edu.cn"]
    start_urls = ["http://mse.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkumseSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'mse' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"mse_{self.page_id}.png"
