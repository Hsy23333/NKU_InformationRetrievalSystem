...
class nkulibSpider(CrawlSpider): 
    name = "nkulibSpider"         
    allowed_domains = ["lib.nankai.edu.cn"]
    start_urls = ["http://lib.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkulibSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'lib' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"lib_{self.page_id}.png"
