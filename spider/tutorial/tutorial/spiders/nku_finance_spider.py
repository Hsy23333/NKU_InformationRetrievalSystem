...
class nkufinanceSpider(CrawlSpider): 
    name = "nkufinancespider"         
    allowed_domains = ["finance.nankai.edu.cn"]
    start_urls = ["http://finance.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkufinanceSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'finance' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"finance_{self.page_id}.png"
