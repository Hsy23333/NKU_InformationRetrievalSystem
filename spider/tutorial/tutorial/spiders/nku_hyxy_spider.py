...
class nkuhyxySpider(CrawlSpider): 
    name = "nkuhyxySpider"         
    allowed_domains = ["hyxy.nankai.edu.cn"]
    start_urls = ["http://hyxy.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkuhyxySpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'hyxy' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"hyxy_{self.page_id}.png"
