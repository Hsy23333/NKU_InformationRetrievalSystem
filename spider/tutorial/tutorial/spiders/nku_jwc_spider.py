...
class nkujwcSpider(CrawlSpider): 
    name = "nkujwcSpider"         
    allowed_domains = ["jwc.nankai.edu.cn"]
    start_urls = ["http://jwc.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkujwcSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'jwc' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"jwc_{self.page_id}.png"
