...
class nkugraduateSpider(CrawlSpider): 
    name = "nkugraduatespider"         
    allowed_domains = ["graduate.nankai.edu.cn"]
    start_urls = ["http://graduate.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkugraduateSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'graduate' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"graduate_{self.page_id}.png"
