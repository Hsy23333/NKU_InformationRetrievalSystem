...
class nkuskySpider(CrawlSpider): 
    name = "nkuskySpider"         
    allowed_domains = ["sky.nankai.edu.cn"]
    start_urls = ["http://sky.nankai.edu.cn"]
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'sky' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"sky_{self.page_id}.png"
