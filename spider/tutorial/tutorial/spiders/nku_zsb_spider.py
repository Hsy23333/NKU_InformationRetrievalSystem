...
class nkuzsbSpider(CrawlSpider): 
    name = "nkuzsbspider"         
    allowed_domains = ["zsb.nankai.edu.cn"]
    start_urls = ["http://zsb.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkuzsbSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'zsb' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"zsb_{self.page_id}.png"
