...
class nkuzfxySpider(CrawlSpider): 
    name = "nkuzfxySpider"         
    allowed_domains = ["zfxy.nankai.edu.cn"]
    start_urls = ["http://zfxy.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkuzfxySpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'zfxy' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"zfxy_{self.page_id}.png"
