...
class nkupharmacySpider(CrawlSpider): 
    name = "nkupharmacySpider"         
    allowed_domains = ["pharmacy.nankai.edu.cn"]
    start_urls = ["http://pharmacy.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkupharmacySpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        snapshot_name = f"pharmacy_{self.page_id}.png"
