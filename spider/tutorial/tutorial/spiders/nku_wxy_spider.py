...
class nkuwxySpider(CrawlSpider): 
    name = "nkuwxySpider"         
    allowed_domains = ["wxy.nankai.edu.cn"]
    start_urls = ["http://wxy.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkuwxySpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'wxy' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"wxy_{self.page_id}.png"
