...
class nkuchemSpider(CrawlSpider): 
    name = "nkuchemSpider"         
    allowed_domains = ["chem.nankai.edu.cn"]
    start_urls = ["http://chem.nankai.edu.cn"]
    ...
    def __init__(self, *args, **kwargs):
        super(nkuchemSpider, self).__init__(*args, **kwargs)
    ...
    def parse_item(self, response):
        ...
        item['source_type'] = 'chem' 
        item['page_links'] = list(set(response.css("a::attr(href)").getall()))

        snapshot_name = f"chem_{self.page_id}.png"
